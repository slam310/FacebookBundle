...
/*
 * This file is part of the BITFacebookBundle package. (c) bitgandtter <http://bitgandtter.github.com/> For the full copyright and license information, please view the LICENSE file that was distributed with this source code.
 */
...
class FacebookExtension extends \Twig_Extension
{
  ...
  public function getFunctions( )
  {
    ...
    $functions [ 'facebook_check_login_status' ] = new \Twig_Function_Method ( $this, 'renderCheckFBLoginStatusFunction', $extra );
  ...
  {
    return $this->container->get ( 'bit_facebook.helper' );
  }
